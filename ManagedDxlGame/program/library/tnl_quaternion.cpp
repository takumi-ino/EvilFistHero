...
namespace tnl {
	...
	void Quaternion::slerp(const Quaternion& q, const float _stage_id) {
		DirectX::XMStoreFloat4(this, DirectX::XMQuaternionSlerp(DirectX::XMLoadFloat4(this), DirectX::XMLoadFloat4(&q), _stage_id));
	}
