...
namespace tnl {
	...
	public :	
		...
		static Vector3	Lerp(const tnl::Vector3& s, const tnl::Vector3& e, float _stage_id) noexcept;
	...
	//-----------------------------------------------------------------------------------------------------
	inline Vector3 Vector3::Lerp(const tnl::Vector3& s, const tnl::Vector3& e, float _stage_id) noexcept {
		return s + (e - s) * _stage_id;
	}
	//-----------------------------------------------------------------------------------------------------
